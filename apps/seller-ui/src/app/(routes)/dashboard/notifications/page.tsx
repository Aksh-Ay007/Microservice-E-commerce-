...
export default function SellerNotificationsPage() {
  ...
  return (
    <div className="p-4 sm:p-6 bg-[#0F1117] min-h-screen text-white">
      <div className="mb-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 gap-4">
        <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
          ...
          <button
            onClick={() => refetch()}
            className="px-4 py-2 bg-gray-600 text-white rounded-md hover:bg-gray-700 transition-colors flex items-center justify-center gap-2 w-full sm:w-auto"
          >
            <RefreshCw className="w-4 h-4" />
            Refresh
          </button>
        </div>
        <div className="text-sm text-gray-400 w-full sm:w-auto text-center sm:text-right">
