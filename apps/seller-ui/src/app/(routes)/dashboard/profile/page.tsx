...
const SellerProfilePage = () => {
  ...
  return (
    <div className="space-y-6 p-4 lg:p-6">
      ...
      <div className="relative">
        ...
        <div className="absolute top-2 right-2 sm:top-4 sm:right-4 flex flex-col sm:flex-row gap-2">
          <button
            ...
            className="bg-white bg-opacity-20 hover:bg-opacity-30 text-white rounded-lg px-3 py-2 sm:px-4 flex items-center gap-2 disabled:opacity-50 transition-all duration-200 text-sm"
          >
            {isUploadingBanner ? (
            ...
            <span className="sm:hidden">{bannerPreview ? "Update" : "Add"}</span>
          </button>
          ...
          {getCurrentBannerUrl() && (
            <button
              ...
              className="bg-red-500 bg-opacity-20 hover:bg-opacity-30 text-white rounded-lg px-3 py-2 sm:px-4 flex items-center gap-2 disabled:opacity-50 transition-all duration-200 text-sm"
            >
              {isDeletingBanner ? (
                <Loader2 className="w-4 h-4 animate-spin" />
              ) : (
      ...
      {/* Avatar Section */}
      <div className="flex flex-col items-center space-y-4 -mt-8 sm:-mt-16 relative z-10">
        <div className="relative">
          <div className="w-24 h-24 sm:w-32 sm:h-32 rounded-full overflow-hidden bg-gray-200 shadow-lg border-4 border-white">
            {getCurrentAvatarUrl() ? (
              <img
        ...
        {(avatarPreview || bannerPreview) && (
          <div className="flex flex-col sm:flex-row gap-3 w-full max-w-md">
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 px-4 py-2 bg-gray-500 text-white rounded-lg hover:bg-gray-600 disabled:opacity-50 transition-colors"
            >
              <X className="w-4 h-4" />
              Cancel
            </button>
      ...
      {/* Shop Information */}
      <div className="bg-[#1C1F29] rounded-lg p-4 sm:p-6 shadow-sm border border-gray-700">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-gray-600 bg-[#0F1117] text-white rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
              </div>
              <div className="space-y-2">
                <label className="text-sm font-medium text-gray-300 flex items-center gap-2">
