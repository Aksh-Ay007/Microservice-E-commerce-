  ...
  return (
    <div className="space-y-6 p-4 sm:p-6">
      ...
      <div className="relative">
        <div className="h-40 sm:h-48 bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg overflow-hidden">
          {getCurrentBannerUrl() ? (
            <img
        ...
        <div className="absolute top-3 right-3 flex gap-2">
          <button
            ...
            className="bg-black/30 hover:bg-black/40 text-white rounded-lg px-3 py-1.5 flex items-center gap-2 disabled:opacity-50 transition-all duration-200"
          >
            {isUploadingBanner ? (
          ...
          {getCurrentBannerUrl() && (
            <button
              ...
              className="bg-red-600/20 hover:bg-red-600/30 text-white rounded-lg px-3 py-1.5 flex items-center gap-2 disabled:opacity-50 transition-all duration-200"
            >
              {isDeletingBanner ? (
                <Loader2 className="w-4 h-4 animate-spin" />
              ) : (
      ...
      {/* Avatar Section */}
      <div className="flex flex-col items-center space-y-4 -mt-14 sm:-mt-16 relative z-10">
        <div className="relative">
          <div className="w-28 h-28 sm:w-32 sm:h-32 rounded-full overflow-hidden bg-gray-800 shadow-lg border-4 border-gray-900">
            {getCurrentAvatarUrl() ? (
              <img
          ...
          <div className="absolute -bottom-2 -right-2 flex gap-2">
            <button
              ...
              className="bg-blue-600 text-white rounded-full p-2.5 sm:p-3 hover:bg-blue-700 disabled:opacity-50 shadow-lg transition-all duration-200 hover:scale-105"
            >
              {isUploadingAvatar ? (
            ...
            {getCurrentAvatarUrl() && (
              <button
                ...
                className="bg-red-600 text-white rounded-full p-2.5 sm:p-3 hover:bg-red-700 disabled:opacity-50 shadow-lg transition-all duration-200 hover:scale-105"
              >
                {isDeletingAvatar ? (
                  <Loader2 className="w-5 h-5 animate-spin" />
                ) : (
        ...
        {compressionInfo && (
          <div className="text-center">
            <p className="text-sm text-gray-300 bg-gray-800 border border-gray-700 px-3 py-2 rounded-lg">
              {compressionInfo}
            </p>
          </div>
        )}
      ...
      {/* Shop Information */}
      <div className="rounded-lg p-6 card-dark">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-gray-700 rounded-lg bg-transparent text-white placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
              </div>
              <div className="space-y-2">
                <label className="text-sm font-medium text-gray-300 flex items-center gap-2">
