    ...
    <div className="space-y-6 p-4 md:p-6">
      ...
      <div className="flex flex-col md:flex-row gap-3 md:gap-0 md:justify-between md:items-center">
        ...
        <button
          ...
          className="flex items-center gap-2 px-3 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors text-sm md:text-base"
        >
      ...
      <div className="relative">
        <div className="h-36 md:h-48 bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg overflow-hidden">
          {getCurrentBannerUrl() ? (
            <img
        ...
        <div className="absolute top-3 right-3 flex gap-2">
          <button
            ...
            className="bg-white bg-opacity-20 hover:bg-opacity-30 text-white rounded-lg px-3 py-2 flex items-center gap-2 disabled:opacity-50 transition-all duration-200 text-sm"
          >
            {isUploadingBanner ? (
          ...
          {getCurrentBannerUrl() && (
            <button
              ...
              className="bg-red-500 bg-opacity-20 hover:bg-opacity-30 text-white rounded-lg px-3 py-2 flex items-center gap-2 disabled:opacity-50 transition-all duration-200 text-sm"
            >
              {isDeletingBanner ? (
                <Loader2 className="w-4 h-4 animate-spin" />
              ) : (
        ...
        <div className="relative">
          ...
          <div className="absolute -bottom-2 -right-2 flex gap-2">
            <button
              ...
              className="bg-blue-500 text-white rounded-full p-2 md:p-3 hover:bg-blue-600 disabled:opacity-50 shadow-lg transition-all duration-200 hover:scale-105"
            >
              {isUploadingAvatar ? (
            ...
            {getCurrentAvatarUrl() && (
              <button
                ...
                className="bg-red-500 text-white rounded-full p-2 md:p-3 hover:bg-red-600 disabled:opacity-50 shadow-lg transition-all duration-200 hover:scale-105"
              >
                {isDeletingAvatar ? (
                <Loader2 className="w-4 h-4 md:w-5 md:h-5 animate-spin" />
                ) : (
          ...
          <div className="flex gap-3 flex-wrap justify-center">
            {avatarPreview && (
              <button
                ...
                disabled={isUploadingAvatar}
                className="flex items-center gap-2 px-3 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600 disabled:opacity-50 transition-colors text-sm"
              >
