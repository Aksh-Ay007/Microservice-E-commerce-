  ...
  return (
    <div className="w-full mx-auto p-4 md:p-8 text-white">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
        ...
        <div className="bg-gray-900 border border-gray-800 p-6 rounded-lg shadow-md space-y-6">
          <h2 className="text-xl font-semibold text-gray-100 border-b border-gray-800 pb-3">
            Event Details
          </h2>
            ...
            <Controller
              ...
              render={({ field, fieldState }) => (
                <div>
                  ...
                  <input
                    type="datetime-local"
                    className="w-full border border-gray-700 bg-transparent text-white rounded-lg p-2.5"
                    {...field}
                  />
                  {fieldState.error && (
                    <p className="mt-1 text-sm text-red-400">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div>
              ...
              <select
                ...
                className="w-full border border-gray-700 bg-transparent text-white rounded-lg p-2.5 disabled:bg-gray-800 disabled:text-gray-500"
              >
